...
## [1.9.0] 2020-05-27
### Bug fixing
- https://github.com/creativetimofficial/issues/121
- https://github.com/creativetimofficial/issues/98
- https://github.com/creativetimofficial/pull/99
- https://github.com/creativetimofficial/pull/65
### Major style changes
### Deleted components
### Added components
...
### Major style changes
- Renamed `assets/jss/layouts/projectStyle.js` to `assets/jss/layouts/adminStyle.js`
### Deleted components
### Added components
### Deleted dependencies
### Added dependencies
...
- Solved https://github.com/creativetimofficial/issues/83
### Major style changes
### Deleted components
### Added components
### Deleted dependencies
...
## [1.6.0] 2019-02-13
### Nice stuff
- [Added RTL support](https://github.com/creativetimofficial/issues/16)
### Bug Fixing
- [Added new script for npm](https://github.com/creativetimofficial/issues/69)
- Changed our buggy routing system, now it should work flawlessly, for more info, please refer to our [live docs here](https://demos.creative-tim.com/#/documentation/routing-system)
- [https://github.com/creativetimofficial/issues/67](https://github.com/creativetimofficial/issues/67)
- [https://github.com/creativetimofficial/issues/68](https://github.com/creativetimofficial/issues/68)
- [https://github.com/creativetimofficial/issues/66](https://github.com/creativetimofficial/issues/66)
### Major style changes
...
- **src/components/SnackbarContent.jsx**
...
- Github solved issues:
  - `https://github.com/creativetimofficial/issues/58`
...
- Github solved issues:
  - https://github.com/creativetimofficial/issues/49 (dropped `react-popper` in favour of `@material-ui/core/Popper`)
  - https://github.com/creativetimofficial/issues/47
  - https://github.com/creativetimofficial/issues/45
  - https://github.com/creativetimofficial/issues/38
  - https://github.com/creativetimofficial/issues/37
- Github enhancement issues:
  - https://github.com/creativetimofficial/issues/47 (read the [./README.md](./README.md) file)
### Major style changes
- Added styles for `svg`'s, **font-awesome** classes and `.material-icons` class inside
  - `src/assets/jss/pages/projectStyle.jsx`
...
### Added components
- `src/components/GridContainer.jsx` (instead of MUI's `<Grid container...` component)
### Deleted dependencies
### Added dependencies
### Update dependencies
...
- Moved the styles of `src/pages/` inside `src/assets/jss/pages/`
- Almost all styles have been changed more or less
### Dropped components
- `src/components/CustomButtons/IconButton.jsx` (instead use `src/components/CustomButtonx` with `justIcon` prop)
...
- Renamed `src/variables/styles.jsx` to `src/assets/jss/rootx`
