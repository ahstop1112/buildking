...
import { Table, Box, TableBody, TableCell, TableHead, TableRow } from "@material-ui/core";
...
const DataTableTabs = props => {
  const { context, divisionId } = props;
  const page = useContext(context);
  const pageState = page.state;
  const [value, setValue] = useState(0);
  const items = pageState['data'];
