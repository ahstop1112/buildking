  ...
  return (
    <Box mb={10}>
      ...
      <Typography variant="subtitle1" gutterBottom my={4}>
        ...
        . You'll need to install Node.js (v12 or up) before using Cerebro Inspection CMS.
      </Typography>
      ...
      <Typography variant="subtitle1" gutterBottom my={4}>
        ...
        Cerebro Inspection CMS's dependencies. All dependencies will be downloaded to
      ...
      <Typography variant="subtitle1" gutterBottom my={4}>
        ...
        <code>build/</code>
        files. Cerebro Inspection CMS is using webpack and webpack-serve to
