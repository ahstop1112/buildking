...
function HowItWorks() {
  return (
    <Box mb={10}>
      ...
      <Typography variant="subtitle1" gutterBottom my={4}>
        Material-UI's <Link href="https://material-ui.com/customization/theming/#createmuitheme-options-args-theme" target="_blank" rel="noreferrer noopener">createMuiTheme</Link> is used to extend Material-UI's default styling. Cerebro Inspection CMS is using both the Material-UI ThemeProvider as Styled-Components ThemeProvider. This way, global theme variables will be applied to both Material-UI's components as custom Styled-Components.</Typography>
      <Typography variant="subtitle1" gutterBottom my={4}>
