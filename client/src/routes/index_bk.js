...
const RolesPage = async(() => import("../pages/RolePage"));
...
const pagesRoutes = {
  ...
  children: [
    {
      path: "/web/admin/pages/settings",
      name: "Settings",
      component: Settings
    },
    {
      path: "/web/admin/pages/pricing",
      name: "Pricing",
      component: Pricing
    },
    {
      path: "/web/admin/pages/blank",
      name: "Blank Page",
      component: Blank
    }
  ],
...
const rolesAddRoutes = {
  id: "Roles",
  path: "/web/admin/roles/add",
  icon: <User />,
  component: RolesPage,
  children: null,
  isShown: false
...
const rolesEditRoutes = {
  id: "Roles",
  path: "/web/admin/roles/edit/:roleId",
  icon: <User />,
  component: RolesPage,
  children: null,
  isShown: false
...
export const dashboardLayoutRoutes = [
  ...
  formRoutes,
  formTemplatesRoutes,
  formTemplatesAddRoutes,
  formTemplatesEditRoutes,
  rolesRoutes,
  rolesAddRoutes,
  rolesEditRoutes,
  // pagesRoutes,
